...
<!-- Please read https://github.com/linuxserver/docker-baseimage-fedora/blob/41/.github/CONTRIBUTING.md -->
...
A custom base image built with [Fedora Linux](https://fedoraproject.org) and [s6-overlay](https://github.com/just-containers/s6-overlay).
...
- Fedora releases are supported for 1 year, after which we will stop building new base images for that version.
